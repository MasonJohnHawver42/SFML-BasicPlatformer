...
template<class T> void Vector<T>::add(double val1, double val2) {
  y += val2;
  x += val1;
}

template<class T> void Vector<T>::sub(double val1, double val2) {
  y -= val2;
  x -= val1;
}

template<class T> void Vector<T>::mult(double val1, double val2) {
  y *= val2;
  x *= val1;
}

template<class T> void Vector<T>::div(double val1, double val2) {
  if (val1 != 0 & val2 != 0) {
    y /= val2;
    x /= val1;
  }
